...
connection_url = 'mongodb+srv://subishek:Subi05072001@subi-cluster.enclmwp.mongodb.net/?retryWrites=true&w=majority'
app = Flask(__name__)
client = pymongo.MongoClient(connection_url)


Database = client.get_database('TaskDB')

SampleTable = Database.Task1
